...
//                     }},
					{ title:'股票代码', name:'id' ,width:60, align:'center', sortable: true},
                    ...
                    { title:'成交金额(亿元)', name:'volume' ,width:100, align:'center', sortable: true, type: 'number', renderer: function(val){
                        return val.toFixed(2);
                    }},
                    { title:'涨幅', name:'adj_price' ,width:60, align:'center', sortable: true, type: 'number', renderer: fixed2},
